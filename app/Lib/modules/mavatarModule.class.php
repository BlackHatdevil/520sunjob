...
class mavatarModule extends BaseModule
{
	...
	public function upload()
	{
	    ...
	    if (is_animated_gif($_FILES['avatar_file']['tmp_name']))
	    {
	    	...
	    	$im = get_spec_gif_anmation($rs['avatar_file']['path'],36,36);
		...
		$img_result = save_image_upload($_FILES,"avatar_file","avatar/temp",$whs=array('small'=>array(36,36,1,0),'middle'=>array(120,120,1,0),'big'=>array(200,200,1,0)));
		//开始移动图片到相应位置
